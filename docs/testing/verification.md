...
**locator／引文補正（2026-09-25）**：再核對維基文庫卷一電子文本，累計校正 **10 筆**：
① 馬頭帶劍原記卷三／格局，實位於卷一〈**定貴局**〉（「某某 謂…是也」逐條段）；
② 得地合格訣／失陷破格訣之 `quote` 原僅為 wikitext 標題佔位（`===…===`），
已改為該訣**首條逐字**（並確認兩訣位於卷一〈十二宮諸星得地／失陷訣〉，非〈論格局〉段）。
馬頭帶劍另記錄同書 3 處相關句（卷一〈骨髓賦〉「馬頭帶劍，鎮衛邊疆」、卷一女命骨髓賦註
「马头带剑非夭折则主刑伤」、卷三「擎羊子午卯酉非夭折而刑伤…马头带剑，吉多勿论」），
吉凶語意不一 → 校勘需求提高，仍不得實作。
